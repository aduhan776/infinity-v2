...
import useAdmin from '../hooks/useAdmin'; // 🎯 Custom Hook Imported

const TestSeries = ({ onStartTest, selectedFolder, setSelectedFolder, onViewAnalysis }) => {
  // 🚨 FIXED: Hardcoded true removed. Now dynamically fetches from database
...
// --- STYLES ARCHITECTURE SCHEMAS MAP (HIGH-FIDELITY MONOCHROME DESIGN) ---
