  ...
  return (
    <div className="dashboard-wrapper" style={dashboardLayoutWrapper}>
      <style>{`
        ...
        .nx-folder-card:hover { border-color: #C6C2E8 !important; box-shadow: 0 4px 16px rgba(112, 101, 186, 0.14) !important; }
      `}</style>
